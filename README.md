This is a [Laravel](https://Project_1_AA.org/) project bootstrapped with `composer create-project Project_1_AA/Project_1_AA Project_1_AA-wasmer-example` (with some minor adaptations for Wasmer).
